...
const Footer = () => {
  const [email, setEmail] = useState("");
  {
    ...
    ../../baseUrlform = document.getElementById('.form');
    ...
    return (
        <section className="footerScreen" id="footerScreen">
            <section className="footerScreen__upperContainer">
                <section className="footerScreen__upperContainer__cloud">
                    <img src={Top_Cloud} className="footerScreen__upperContainer__cloud__cloudTop" alt="top cloud" />
                </section>
                <section className="footerScreen__upperContainer__subscribeContainer">
                    <div className="card">
                        <h2 className="title">SUBSCRIBE</h2>
                        <p className="text">to our newsletter. Please enter your email and press enter</p>
                        <svg className="line" viewBox="0 0 340 110" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className="line2" viewBox="0 0 50 52" xmlns="http://www.w3.org/2000/svg">
                            <path d="m 38.391765,17.110953 -16.66751,16.667516 -7.81073,-7.201053 c -2.56639,-2.366065 -3.80148,-3.574166 -6.56097,-5.722314 l -4.6426304,-1.736535" fill="none" stroke="#000000" stroke-width="2" />
                        </svg>
                        <form id="form" action="">
...
=======
  ...
  // activates after user hits enter after typing out theri email
  const handleFormSubmit = async (e) => {
    ...
    Swal.fire({
      ...
      text: "You ll get exclusive updates and be the first to be notified on latest dungeon hunt updates !",
    });
  };
    ...
    <section className="footerScreen" id="footerScreen">
      <section className="footerScreen__upperContainer">
        ...
        <section className="footerScreen__upperContainer__subscribeContainer">
          <div class="card">
            ...
            <p class="text">
              to our newsletter. Please enter your email and press enter
            </p>
            ...
            <svg class="line2" viewBox="0 0 50 52">
              <path
                d="m 38.391765,17.110953 -16.66751,16.667516 -7.81073,-7.201053 c -2.56639,-2.366065 -3.80148,-3.574166 -6.56097,-5.722314 l -4.6426304,-1.736535"
                fill="none"
                stroke="#000000"
                stroke-width="2"
              />
      ...
      <section className="footerScreen__bottomContainer">
        ...
        <section className="footerScreen__bottomContainer__companyInfo">
          <img
            src={Logo}
            className="footerScreen__bottomContainer__companyInfo__logo"
            alt="Into The Verse  logo"
          />
        </section>
      </section>
    </section>
